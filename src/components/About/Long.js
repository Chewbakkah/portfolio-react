  ...
  return (
    <div>
      <p className="about-text">
        ...
        80's. 1-in-20 pronounces my first name right on the first try. It is
        ...
        After attending high school in Bay City I enrolled at Abilene Christian University in 2001 where it took me two years to learn how to ACTUALLY study. I graduated with a Bachelor's of Science degree in Digital Media from the school of Journalism and Mass Communication. This is long way of saying I learned how to work in Media. More recently I've completed a continuing education course through The University of Texas at Austin in Full Stack Web Development. Aside from some very useful developer skills I also learned that, as and adult, I am fifty times the student I ever was previously.
        <br /><br />
        <span className="sub-heading">Work:</span><br />
        I started working at the very young age of 10, yes 10. My parents instilled a very strict work ethic in me early on, and it has benefited me greatly. My first job was emptying trash and vacuuming the church auditorium. Around the age of 13 I was ready to quit and even did, for a week. At that time my Mom figured out she didn't want to deal with the vacuuming and hired me on at three times my previous rate. Aside from a six month stretch my freshman year of college, where my job was to "study", I have not spent a day of my life unemployeed. I've done everything from janitorial work, fast food, training employees for Texas Roadhouse, carpentry work, to even working as a cashier at Blockbuster, which wasn't as cool as you'd think. I've spent the last 12 years as a graphic designer working at Reynolds and Reynods, and now I'm looking to expand my skills into Web Development.
        <br /><br />
        <span className="sub-heading">Hobbies:</span><br />
        My favorite hobby that I'll never give up is video games. Aside from that I dabble in some wood working and competitive sleeping.
      </p>
    </div>
  );
};
